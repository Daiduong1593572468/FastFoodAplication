...
import 'package:fastfood/fastfood/presentations/screens/more/my_order_view.dart';
...
class ItemDetailsView extends StatefulWidget {
  final Food food;
  const ItemDetailsView({Key? key, required this.food}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: FutureBuilder<Food>(
          future: FoodRequest.getById(widget.food.Id!),
